...
class Category(models.Model):
    ...
    def get_absolute_url(self):
        return reverse('blog:post_by_category', args=[str(self.slug)])
...
class Tag(models.Model):
    ...
    def get_absolute_url(self):
        return reverse('blog:post_by_tag', args=[str(self.slug)])
...
class Post(models.Model):
    ...
    def get_absolute_url(self):
        return reverse('blog:post_detail', args=[str(self.pk), self.slug],)
